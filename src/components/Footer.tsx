          ...
          <div>
            ...
            <div className="space-y-3">
              <div className="flex items-start">
                ...
                <div>
                  <p className="text-gray-400">Altay Mahallesi</p>
                  <p className="text-gray-400">Söğüt Caddesi No:37/2</p>
                  <p className="text-gray-400">(Arya Nüans Residence)</p>
                  <p className="text-gray-400">Eryaman, Ankara, Türkiye</p>
                </div>
              </div>
